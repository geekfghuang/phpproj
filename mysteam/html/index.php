...
<div id="container">
    ...
    <div id="box13">
    <span id="home">Steam home</span>
        <ul>
           <li><img src="../img/23.jpg" class="pic" onClick="cli_1()"> </li>
           <li><img src="../img/19.jpg" class="pic" onClick="cli_2()"></li>
           <li><img src="../img/30.jpg" class="pic" onClick="cli_3()"></li>
           <li><img src="../img/41.png" class="pic" onClick="cli_4()"></li>
       </ul>
    </div>
    <div id="box14">
    <a id="ck2" style="background-color:#60b6e7; color:#FFFFFF;" onClick="clickevent2(this)">所有商品</a>
    <a id="ck1" onClick="clickevent1(this)">最新上架</a>
    <a id="ck3" onClick="clickevent3(this)">热销排行</a>
    </div>
...
<div id="box6">
   ...
   <img src="../img/2.png" id="box6_img" onClick="click_login_pic()">
   <div id="box8">
