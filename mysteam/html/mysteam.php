...
<meta charset="utf-8">
<title>mysteam</title>
<link rel="stylesheet" type="text/css" href="../css/mysteam.css">
...
<div id="container">
    ...
    <div id="box14">
        <a id="ck2" style="background-color:#60b6e7; color:#FFFFFF;" onClick="clickevent2(this)">已经购买</a>
        <a id="ck1" onClick="clickevent1(this)">已经上架</a>
        <a id="ck3" onClick="clickevent3(this)">已经售出</a>
    </div>
    <div id="box15" >
    </div>
    <div id="box16">
    <span id="box16span">&nbsp;&nbsp;点击左侧商品图片即可查看相应信息</span>
    </div>
    <div id="box17">
       <div id="box18" onClick="clickbox18()">
       <span id="box18_zi">去发货</span>
       </div>
    </div>
</div>
<div id="yejiao">
