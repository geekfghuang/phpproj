...
<div id="box1">
  <div id="box2">
       ...
       <div id="box3">
           ...
           <a href="mysteam.php" onMouseOver="mouseoverevent0(this)" onMouseOut="mouseoutevent0(this)">my steam</a>
...
<div id="container">
   <div id="box11">
   <br /><br />
   <span style="color:#FFFFFF; opacity:0.8;">创建 Steam 帐户名称</span><br />
   <input type="text" id="username" onBlur="blurevent1()" style="background-color:#2a3e5a; border-radius:3px; border-color:#1b2838;">      &nbsp;&nbsp;<span id="text1"></span>
   <br /><br /><br />
   <span style="color:#FFFFFF; opacity:0.8;">请输入密码</span><br />
   <input type="password" id="password" onBlur="blurevent2()" style="background-color:#2a3e5a; border-radius:3px; border-color:#1b2838;">
    &nbsp;&nbsp;<span id="text2"></span>
   <br /><br /><br />
   <span style="color:#FFFFFF; opacity:0.8;">请重新输入密码</span><br />
   <input type="password" id="password2" onBlur="blurevent3()" style="background-color:#2a3e5a; border-radius:3px; border-color:#1b2838;">&nbsp;&nbsp;<span id="text3"></span>
   <br /><br /><br />
   <span style="color:#FFFFFF; opacity:0.8;">请输入你的邮箱地址</span><br />
   <input type="text" id="email" onBlur="blurevent4()" style="background-color:#2a3e5a; border-radius:3px; border-color:#1b2838;">&nbsp;&nbsp;<span id="text4"></span>
   <br /><br /><br />
   <span style="color:#FFFFFF; opacity:0.8;">请复查以上协议，并通过选择页面底部的复选框同意此协议。 您必须同意这些协议条款才能继续。</span>
   <div id="box12"><br />
   <pre style="color:#EBE1E1;">STEAM® SUBSCRIBER AGREEMENT
...
All charges incurred on Steam, and all purchases made with the Steam Wallet, are payable in advance and final. However, you may request a refund in certain situations, as described in the Steam Refund Policy http://store.steampowered.com/steam_refunds.
...
Revision date: June 2nd 2015</pre>
   </div>
   <input type="checkbox" id="checkbox"><span style="color:#FFFFFF; opacity:0.8; font-size:10px;">我同意并且已年满 13 周岁</span><br /><br />
   <img src="../img/8.png" style="margin-left:580px; opacity:0.7;" onMouseOver="mouseoverevent4(this)" onMouseOut="mouseoutevent4(this)" onClick="clickevent1()">
   <div id="headimg_put">
   <span id="headimg_span">上传头像</span>
   <input type="file" id="headimg_input" onChange="headimg_put()">
   <div id="headimg_see">
   <img id="headimg_see_img">
   </div>
   </div>
   </div>
</div>
