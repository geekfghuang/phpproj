...
<meta charset="utf-8">
<title>编辑个人资料</title>
<link rel="stylesheet" type="text/css" href="../css/p_file_change.css">
<link rel="shortcut icon" href="../img/6.png">
<script type="text/javascript" src="../js/jquery-2.0.0.min.js"></script>
<script type="text/javascript" src="../js/p_file_change.js"></script>
</head>
<body>
<div id="box1">
  <div id="box2">
...
<div id="container">
    ...
    <div id="box13">
        <div id="username">
        <span id="username_span">用户名</span>
        </div>
        <input type="text" id="username_input">
        
        <div id="age">
        <span id="age_span">年龄</span>
        </div>
        <input type="number" id="age_input">
        
        <div id="email">
        <span id="email_span">邮箱</span>
        </div>
        <input type="text" id="email_input">
        
        <div id="phone">
        <span id="phone_span">电话</span>
        </div>
        <input type="text" id="phone_input">
        
        <div id="address">
        <span id="address_span">地址</span>
        </div>
        <input type="text" id="address_input">
        
        <div id="headimgdiv">
        <span id="headimgdiv_span">头像</span>
        </div>
        <input type="file" id="headimg_file" onChange="changeheadimg()">
        
        <div id="headimg_see">
        <img id="headimg_see_pic" width="100%" height="100%">
        </div>
    </div>
